...
describe('total likes', () => {
  ...
  test('of a bigger list is calculated correctly', () => {
    ...
    expect(result).toBe(30) // La suma de 5 + 10 + 15
  })
})
...
describe('favorite blog', () => {
  ...
  test('of a list is the blog with most likes', () => {
  ...
  test('of a list is the blog with a lot of favorites', () => {
    const result = listHelper.favoriteBlog(alotFavorites)
    const expectResult = {
      title: alotFavorites[1].title,
      author: alotFavorites[1].author,
      likes: alotFavorites[1].likes,
    }
    expect(result).toEqual(expectResult)
  })
})
